...
columns5 = [TableColumn(field="a", title="Games Played", formatter=NumberFormatter(text_align='center')),
            TableColumn(field="b", title="Average Bankroll", formatter=NumberFormatter(text_align='center')),
            TableColumn(field="c", title="Minimum Bankroll", formatter=NumberFormatter(text_align='center'))]
...
def play5():
    ...
    maximum_bankroll.append(df['bankroll'].mean())
    ...
    plot5_sub.y_range.start, plot5_sub.y_range.end = 0, phi*max(avg_max_bankroll)
